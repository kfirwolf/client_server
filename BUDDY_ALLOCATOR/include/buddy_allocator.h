...
int buddy_alloc_free(buddy_allocator_t *b_alloc, block_t *block);
...
// block getter
int buddy_alloc_get_block_level(const block_t *blk, uint32_t *blk_level);
int buddy_alloc_get_block_offset(const block_t *blk, uint32_t *blk_offset);
